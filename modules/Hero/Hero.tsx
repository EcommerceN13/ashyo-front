            ...
            banners.map((item: BannerType) => (
              <SwiperSlide className='pt-[37px] pb-[63px] z-[-99999] sm:pt-[145px] relative sm:pb-[150px]' key={item.id}>
                <div className='w-full sm:w-[40%] lg:w-[596px]'>
                  ...
                  <Button extraClass='!text-[12px] !py-[12px] !w-[161px]' type='button' title='Batafsil' />
                </div>
                <Image className='w-[200px] h-[200px] sm:w-[400px] sm:h-[400px] bottom-0 absolute sm:top-0 sm:my-auto right-5' src={`${IMAGE_API}/${item.image}`} alt='Brand img' width={400} height={600} />
              </SwiperSlide>
            ))}
        </Swiper>
      </div>
